...
public class RmlMapper {
    ...
    public static boolean map(){
        ...
        // Path to RML rules file
        String templateFile = "semanticMeasurementsRmlRules.ttl";
        // Path to RML mapping results
        String outputFile = "semanticMeasurementsRmlResults.ttl";
